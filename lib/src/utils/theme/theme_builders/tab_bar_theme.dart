...
/// This extension method for the [ZetaSemantics] class provides a new [tabBarTheme]
/// method. It enables the customization of a [TabBarTheme] to match the [ZetaSemantics].
///
...
extension TabBarExtension on ZetaSemantics {
  ...
  ///
  /// Returns a [TabBarTheme] that matches the [ZetaSemantics].
