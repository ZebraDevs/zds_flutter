...
/// An extension on the [ZetaSemantics] class that adds the method
/// [appBarTheme] for creating an [AppBarTheme] object.
extension ZetaAppBarTheme on ZetaSemantics {
  ...
  AppBarTheme appBarTheme(TextTheme textTheme, Color background) {
    ...
    final foreground = primitives.cool.shade90; // Replace with appropriate logic if needed.

    // Return an AppBarTheme instance built using the resolved foreground color and provided parameters.
    return AppBarTheme(
