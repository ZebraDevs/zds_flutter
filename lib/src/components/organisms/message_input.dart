...
class ZdsMessageInputState extends State<ZdsMessageInput> with SingleTickerProviderStateMixin {
  ...
  bool get _hasText => false;

  set _hasText(bool hasText) {
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          boxShadow: [
            BoxShadow(offset: const Offset(0, -1), color: zetaColors.textDefault.withOpacity(0.5), blurRadius: 2),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty<bool>('hasText', _hasText))
      ..add(DiagnosticsProperty<TextEditingController>('messageController', _messageController));
  }
}
