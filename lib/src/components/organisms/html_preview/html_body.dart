  ...
  Map<String, Style> _buildStyles(BuildContext context, ColorScheme colorscheme, BoxConstraints box) {
    return <String, Style>{
      ...
      'tr': Style(
        ...
        width: Width.auto(),
        border: Border(
          bottom: BorderSide(color: colorscheme.onSurface, width: 0.5),
          left: BorderSide(color: colorscheme.onSurface, width: 0.5),
          right: BorderSide(color: colorscheme.onSurface, width: 0.5),
