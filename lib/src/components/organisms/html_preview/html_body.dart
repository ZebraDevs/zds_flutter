  ...
  Map<String, Style> _buildStyles(BuildContext context, ColorScheme colorscheme, BoxConstraints box) {
    ...
    return <String, Style>{
      ...
      'table': Style(
        ...
        width: Width.auto(),
        border: Border(
          bottom: BorderSide(color: zetaColors.borderDefault),
          left: BorderSide(color: zetaColors.borderDefault),
          right: BorderSide(color: zetaColors.borderDefault),
          top: BorderSide(color: zetaColors.borderDefault),
        ),
      ),
      'tr': Style(
        margin: Margins.zero,
        ...
        width: Width.auto(),
        border: Border(
          bottom: BorderSide(color: zetaColors.borderDefault, width: 0.5),
          left: BorderSide(color: zetaColors.borderDefault, width: 0.5),
          right: BorderSide(color: zetaColors.borderDefault, width: 0.5),
          top: BorderSide(color: zetaColors.borderDefault, width: 0.5),
        ),
      ),
      'th': Style(
        margin: Margins.zero,
