                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                ...
                                colors: <Color>[
                                  surfaceColor.surface.withValues(alpha: 0.3),
                                  surfaceColor.surface.withValues(alpha: 0.4),
                                  surfaceColor.surface.withValues(alpha: 0.5),
                                  surfaceColor.surface.withValues(alpha: 0.6),
                                  surfaceColor.surface.withValues(alpha: 0.7),
                                  surfaceColor.surface.withValues(alpha: 0.8),
                                  surfaceColor.surface.withValues(alpha: 0.9),
